...
def deadline_override(
    ...
    override = DeadlineOverride(
        ...
        new_deadline=datetime.utcnow() + timedelta(days=100),
...
def test_export_deadline_overrides_csv_unauthorized(
    ...
    # Should fail because non-admin user
    # Note: The actual behavior depends on the endpoint's auth implementation
    # If it checks for MLGOO_DILG role, this would return 403
