        ...
        <div className="text-sm text-blue-800 space-y-2">
          <p>
            ...
            <code className="bg-blue-100 px-1 rounded">
              SulopBarangayMap.tsx
            </code>{' '}
            and replace the placeholder rectangles with your actual SVG paths
          </p>
          <p>
            <strong>2.</strong> Ensure each path's <code className="bg-blue-100 px-1 rounded">id</code> attribute matches the barangay IDs in this demo data
          </p>
          <p>
            <strong>3.</strong> Copy the sample barangay data from this file to use as reference
          </p>
          <p>
            <strong>4.</strong> Integrate the component into your Analytics Dashboard or Reports page
          </p>
          <p>
