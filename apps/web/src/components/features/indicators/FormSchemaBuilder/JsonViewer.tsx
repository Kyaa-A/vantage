    ...
    <div className="mx-auto max-w-5xl p-6">
      ...
      <div className="relative rounded-lg border border-gray-200 bg-gray-900">
        ...
        <div className="border-t border-gray-700 bg-gray-800 px-4 py-2 text-xs text-gray-400">
          <div className="flex items-center justify-between">
            <span>
              {fields.length} field{fields.length !== 1 ? 's' : ''} • {jsonString.split('\n').length} lines • {new Blob([jsonString]).size} bytes
            </span>
      ...
      <div className="mt-6 rounded-lg border border-blue-200 bg-blue-50 p-4">
        <p className="text-sm text-blue-900">
          <strong>Tip:</strong> This JSON can be used with the POST /api/v1/indicators endpoint to create an indicator with this form schema.
        </p>
      </div>
    </div>
  );
