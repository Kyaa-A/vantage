...
export function NumberInputProperties({ fieldId }: NumberInputPropertiesProps) {
  ...
  const onSave = (data: FormValues) => {
    const updates: Partial<NumberInputField> = {
      ...
      min_value: data.min_value !== undefined && data.min_value !== null ? Number(data.min_value) : undefined,
      max_value: data.max_value !== undefined && data.max_value !== null ? Number(data.max_value) : undefined,
      placeholder: data.placeholder || undefined,
      default_value: data.default_value !== undefined && data.default_value !== null ? Number(data.default_value) : undefined,
    };
  ...
  return (
    <form onSubmit={handleSubmit(onSave)} className="space-y-6">
      ...
      <div className="flex gap-3 pt-4 border-t border-gray-200">
        <Button
          type="submit"
          disabled={!hasChanges || hasMinMaxError}
          className="flex-1"
        >
          Save Changes
        </Button>
