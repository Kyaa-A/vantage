...
/**
 * TextInputProperties Component
 *
 * Configuration form for text input fields.
 */
  ...
  return (
    <form onSubmit={handleSubmit(onSave)} className="space-y-6">
      ...
      <div className="space-y-2">
        ...
        <Input id="max_length" type="number" {...register('max_length', { valueAsNumber: true })} placeholder="255" />
      </div>
      ...
      <div className="space-y-2">
        ...
        <Input id="default_value" {...register('default_value')} />
      </div>
