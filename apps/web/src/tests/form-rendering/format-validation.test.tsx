...
describe('Field Format Validation', () => {
  describe('Email Validation', () => {
    it('should validate email field has pattern rule', () => {
      const emailField = validationRulesSchema.fields.find(
        (f) => f.name === 'email_field'
      );
    ...
    it('should provide helpful error message for invalid email', () => {
      ...
      expect(emailField?.validation?.message).toBe(
  ...
  describe('Phone Number Validation', () => {
    it('should validate phone field has pattern rule', () => {
      const phoneField = validationRulesSchema.fields.find(
        (f) => f.name === 'phone_field'
      );
    ...
    it('should provide helpful error message for invalid phone', () => {
      ...
      expect(phoneField?.validation?.message).toBe(
  ...
  describe('URL Validation', () => {
    it('should validate URL field has pattern rule', () => {
      const urlField = validationRulesSchema.fields.find(
        (f) => f.name === 'url_field'
      );
...
describe('Number Range Validation', () => {
  ...
  describe('Validation Error Messages', () => {
    it('should provide message for value below minimum', () => {
      ...
      const errorMessage =
        value < field.min ? `Minimum value is ${field.min}` : null;
    ...
    it('should provide message for value above maximum', () => {
      ...
      const errorMessage =
        value > field.max ? `Maximum value is ${field.max}` : null;
    ...
    it('should provide combined min/max message', () => {
      ...
      expect(percentageField?.validation?.message).toBe(
  ...
  describe('Combined Validations', () => {
    it('should validate both required and range', () => {
      ...
      const requiredError =
        field.required && (value1 === null || value1 === undefined)
          ? 'Budget is required'
          : null;
    ...
    it('should validate format and required together', () => {
      ...
      const value1 = '';
      const requiredError =
        emailField?.required && value1.trim().length === 0
      ...
      const formatError = !pattern.test(value2)
        ? emailField?.validation?.message
        : null;
