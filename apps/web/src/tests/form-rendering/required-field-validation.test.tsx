...
describe('Required Field Validation', () => {
  describe('Required Field Detection', () => {
    it('should identify required fields in schema', () => {
      const requiredFields = allFieldTypesSchema.fields.filter(
        (f) => f.required === true
      );
    ...
    it('should mark text field as required', () => {
      const textField = allFieldTypesSchema.fields.find(
        (f) => f.name === 'text_field'
      );
    ...
    it('should mark checkbox field as optional', () => {
      const checkboxField = allFieldTypesSchema.fields.find(
  ...
  describe('Validation Messages', () => {
    ...
    it('should use field label in error message', () => {
      const field = simpleFormSchema.fields.find(
        (f) => f.name === 'simple_text_field'
      );
  ...
  describe('Field Type Specific Validation', () => {
    ...
    it('should validate required number field is not empty', () => {
      ...
      const isValid = numberField?.required
  ...
  describe('Edge Cases', () => {
    it('should handle field with no required attribute as optional', () => {
      ...
      const isRequired = field.hasOwnProperty('required')
        ? field.required
        : false;
