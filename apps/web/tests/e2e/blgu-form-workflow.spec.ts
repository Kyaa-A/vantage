...
test.describe('BLGU Form Filling Workflow', () => {
  ...
  test('should complete full form filling, saving, and data persistence workflow', async ({ page }) => {
    ...
    const backButton = page.locator('button:has-text("Back")').or(page.locator('a[href*="/blgu"]')).first();
    ...
    console.log('✅ Complete form workflow test passed: fill → save → navigate → reload → verify data persistence');
  });
