...
export const FORM_FIELD_VALUES = {
  TEXT: {
    ...
    description: 'Road rehabilitation and drainage system improvement for the entire barangay area.',
...
export const REWORK_COMMENTS = {
  GENERAL: 'Please review and update the assessment data to ensure all required information is complete and accurate.',
  SPECIFIC_BUDGET: 'The budget allocation appears incomplete. Please provide detailed breakdown and supporting documentation.',
  SPECIFIC_MOV: 'The uploaded Means of Verification document is unclear. Please provide a higher quality scan or photo.',
  SPECIFIC_DESCRIPTION: 'Project description needs more detail. Please include timeline, beneficiaries, and expected outcomes.',
} as const;
 ...
 */
export function generateFormDataForIndicator(indicatorId: number): Record<string, string | string[]> {
  return {
