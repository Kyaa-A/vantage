...
**Exports:**
- `FORM_FIELD_VALUES`: Sample values for all field types (text, number, textarea, radio, checkbox, date)
...
3. **Add meaningful waits**: Use explicit waits (`waitForURL`, `waitForSelector`) instead of arbitrary timeouts
