...
- [ ] **3.1 Story: Backend API for Form Schema Retrieval**
  ...
  - [ ] **3.1.1 Atomic: Create router file for form schema endpoints**
  ...
  - [ ] **3.1.2 Atomic: Implement GET /{indicator_id}/form-schema endpoint structure**
  ...
  - [ ] **3.1.3 Atomic: Retrieve indicator with form_schema from database**
    - **Files:** `apps/api/app/api/v1/indicators.py`
  ...
  - [ ] **3.1.4 Atomic: Add permission check for BLGU users**
    - **Files:** `apps/api/app/api/v1/indicators.py`
  ...
  - [ ] **3.1.5 Atomic: Parse form_schema JSON and include metadata**
    - **Files:** `apps/api/app/api/v1/indicators.py`
  ...
  - [ ] **3.1.6 Atomic: Return FormSchemaResponse schema**
    - **Files:** `apps/api/app/api/v1/indicators.py`
...
- [ ] **3.2 Story: Backend API for Saving Form Responses**
  ...
  - [ ] **3.2.1 Atomic: Create POST /answers endpoint structure**
  ...
  - [ ] **3.2.2 Atomic: Add permission check for assessment ownership**
  ...
  - [ ] **3.2.3 Atomic: Validate that assessment is not locked (status check)**
    - **Files:** `apps/api/app/api/v1/assessments.py`
  ...
  - [ ] **3.2.4 Atomic: Retrieve indicator's form_schema for validation**
    - **Files:** `apps/api/app/api/v1/assessments.py`
  ...
  - [ ] **3.2.5 Atomic: Validate field responses against form_schema**
    - **Files:** `apps/api/app/api/v1/assessments.py`
  ...
  - [ ] **3.2.6 Atomic: Upsert assessment_responses records in database**
    - **Files:** `apps/api/app/api/v1/assessments.py`
  ...
  - [ ] **3.2.7 Atomic: Return SaveAnswersResponse with saved field count**
    - **Files:** `apps/api/app/api/v1/assessments.py`
...
- [ ] **3.3 Story: Backend API for Retrieving Saved Responses**
  ...
  - [ ] **3.3.1 Atomic: Create GET /answers/{indicator_id} endpoint structure**
    - **Files:** `apps/api/app/api/v1/assessments.py`
    - **Dependencies:** Epic 1 Story 1.3 must be complete
  ...
  - [ ] **3.3.2 Atomic: Add permission check for assessment ownership**
    - **Files:** `apps/api/app/api/v1/assessments.py`
  ...
  - [ ] **3.3.3 Atomic: Query all assessment_responses for indicator**
    - **Files:** `apps/api/app/api/v1/assessments.py`
  ...
  - [ ] **3.3.4 Atomic: Return AnswerListResponse schema**
    - **Files:** `apps/api/app/api/v1/assessments.py`
...
- [ ] **3.4 Story: Backend Completeness Validation Endpoint**
  ...
  - [ ] **3.4.1 Atomic: Create POST /validate-completeness endpoint structure**
    - **Files:** `apps/api/app/api/v1/assessments.py`
  ...
  - [ ] **3.4.2 Atomic: Retrieve assessment with all indicators and responses**
    - **Files:** `apps/api/app/api/v1/assessments.py`
  ...
  - [ ] **3.4.3 Atomic: Validate completeness for each indicator using service**
    - **Files:** `apps/api/app/api/v1/assessments.py`
  ...
  - [ ] **3.4.4 Atomic: Aggregate completeness results across all indicators**
    - **Files:** `apps/api/app/api/v1/assessments.py`
  ...
  - [ ] **3.4.5 Atomic: Return CompletenessValidationResponse schema**
    - **Files:** `apps/api/app/api/v1/assessments.py`
...
- [ ] **3.5 Story: Pydantic Schemas for Form Responses**
  ...
  - [ ] **3.5.1 Atomic: Create FormSchemaResponse Pydantic schema**
  ...
  - [ ] **3.5.2 Atomic: Create FieldAnswerInput nested schema**
  ...
  - [ ] **3.5.3 Atomic: Create SaveAnswersRequest Pydantic schema**
    - **Files:** `apps/api/app/schemas/assessment.py`
  ...
  - [ ] **3.5.4 Atomic: Create AnswerResponse Pydantic schema**
    - **Files:** `apps/api/app/schemas/assessment.py`
    - **Dependencies:** None (can be done in parallel)
  ...
  - [ ] **3.5.5 Atomic: Create IncompleteIndicatorDetail nested schema**
    - **Files:** `apps/api/app/schemas/assessment.py`
    - **Dependencies:** None (can be done in parallel)
  ...
  - [ ] **3.5.6 Atomic: Create CompletenessValidationResponse Pydantic schema**
    - **Files:** `apps/api/app/schemas/assessment.py`
  ...
  - [ ] **3.5.7 Atomic: Add Orval tags to all schemas**
...
- [ ] **3.6 Story: Type Generation for Form APIs**
  ...
  - [ ] **3.6.1 Atomic: Verify backend is running for type generation**
  ...
  - [ ] **3.6.2 Atomic: Run pnpm generate-types command**
  ...
  - [ ] **3.6.3 Atomic: Verify generated hooks for form schema endpoint**
  ...
  - [ ] **3.6.4 Atomic: Verify generated hooks for save/get answers endpoints**
  ...
  - [ ] **3.6.5 Atomic: Verify generated hook for completeness validation**
    - **Files:** `packages/shared/src/generated/endpoints/assessments/`
    - **Dependencies:** Task 3.6.2 must be complete
  ...
  - [ ] **3.6.6 Atomic: Verify TypeScript types for all schemas**
...
- [ ] **3.7 Story: Form Schema Parser Utility**
  ...
  - [ ] **3.7.1 Atomic: Create formSchemaParser.ts file with type definitions**
  ...
  - [ ] **3.7.2 Atomic: Implement getSections() helper function**
  ...
  - [ ] **3.7.3 Atomic: Implement getFieldsForSection() helper function**
    - **Files:** `apps/web/src/lib/forms/formSchemaParser.ts`
  ...
  - [ ] **3.7.4 Atomic: Implement isFieldRequired() helper function**
    - **Files:** `apps/web/src/lib/forms/formSchemaParser.ts`
    - **Dependencies:** Task 3.7.1 must be complete
  ...
  - [ ] **3.7.5 Atomic: Implement evaluateConditional() for equals operator**
    - **Files:** `apps/web/src/lib/forms/formSchemaParser.ts`
    - **Dependencies:** Task 3.7.1 must be complete
  ...
  - [ ] **3.7.6 Atomic: Implement evaluateConditional() for notEquals operator**
    - **Files:** `apps/web/src/lib/forms/formSchemaParser.ts`
  ...
  - [ ] **3.7.7 Atomic: Implement evaluateConditional() for greaterThan/lessThan operators**
    - **Files:** `apps/web/src/lib/forms/formSchemaParser.ts`
    - **Dependencies:** Task 3.7.5 must be complete
  ...
  - [ ] **3.7.8 Atomic: Implement evaluateConditional() for contains operator**
    - **Files:** `apps/web/src/lib/forms/formSchemaParser.ts`
    - **Dependencies:** Task 3.7.5 must be complete
  ...
  - [ ] **3.7.9 Atomic: Implement getVisibleFields() using conditional evaluation**
    - **Files:** `apps/web/src/lib/forms/formSchemaParser.ts`
  ...
  - [ ] **3.7.10 Atomic: Add unit tests for formSchemaParser utilities**
...
- [ ] **3.8 Story: Field Type Component Library**
  ...
  - [ ] **3.8.1 Atomic: Create TextFieldComponent for text input**
  ...
  - [ ] **3.8.2 Atomic: Create NumberFieldComponent for number input**
  ...
  - [ ] **3.8.3 Atomic: Create SelectFieldComponent for dropdown selection**
  ...
  - [ ] **3.8.4 Atomic: Create RadioFieldComponent for radio button groups**
  ...
  - [ ] **3.8.5 Atomic: Create CheckboxFieldComponent for checkbox groups**
  ...
  - [ ] **3.8.6 Atomic: Create DateFieldComponent for date selection**
  ...
  - [ ] **3.8.7 Atomic: Create FileFieldComponent placeholder (full implementation in Epic 4)**
  ...
  - [ ] **3.8.8 Atomic: Create field component index file for exports**
  ...
  - [ ] **3.8.9 Atomic: Add component tests for TextFieldComponent**
  ...
  - [ ] **3.8.10 Atomic: Add component tests for NumberFieldComponent**
  ...
  - [ ] **3.8.11 Atomic: Add component tests for SelectFieldComponent**
  ...
  - [ ] **3.8.12 Atomic: Add component tests for RadioFieldComponent and CheckboxFieldComponent**
...
- [ ] **3.9 Story: Dynamic Form Renderer Component**
  ...
  - [ ] **3.9.1 Atomic: Create DynamicFormRenderer component file structure**
  ...
  - [ ] **3.9.2 Atomic: Parse form_schema and extract sections**
  ...
  - [ ] **3.9.3 Atomic: Render section headings and structure**
    - **Files:** `apps/web/src/components/features/forms/DynamicFormRenderer.tsx`
  ...
  - [ ] **3.9.4 Atomic: Render fields for each section using field components**
    - **Files:** `apps/web/src/components/features/forms/DynamicFormRenderer.tsx`
  ...
  - [ ] **3.9.5 Atomic: Implement conditional field visibility logic**
    - **Files:** `apps/web/src/components/features/forms/DynamicFormRenderer.tsx`
  ...
  - [ ] **3.9.6 Atomic: Add loading state for form schema fetch**
    - **Files:** `apps/web/src/components/features/forms/DynamicFormRenderer.tsx`
    - **Dependencies:** Task 3.9.1 must be complete
  ...
  - [ ] **3.9.7 Atomic: Add error state for invalid schema**
    - **Files:** `apps/web/src/components/features/forms/DynamicFormRenderer.tsx`
    - **Dependencies:** Task 3.9.2 must be complete
  ...
  - [ ] **3.9.8 Atomic: Add component tests for DynamicFormRenderer**
...
- [ ] **3.10 Story: Form State Management with React Hook Form**
  ...
  - [ ] **3.10.1 Atomic: Set up React Hook Form in DynamicFormRenderer**
    - **Files:** `apps/web/src/components/features/forms/DynamicFormRenderer.tsx`
    - **Dependencies:** Story 3.9 must be complete
  ...
  - [ ] **3.10.2 Atomic: Generate Zod validation schema from form_schema**
  ...
  - [ ] **3.10.3 Atomic: Integrate Zod validation with React Hook Form**
    - **Files:** `apps/web/src/components/features/forms/DynamicFormRenderer.tsx`
  ...
  - [ ] **3.10.4 Atomic: Load saved responses as default values**
    - **Files:** `apps/web/src/components/features/forms/DynamicFormRenderer.tsx`
  ...
  - [ ] **3.10.5 Atomic: Implement watch() for conditional field logic**
    - **Files:** `apps/web/src/components/features/forms/DynamicFormRenderer.tsx`
  ...
  - [ ] **3.10.6 Atomic: Handle form reset when switching indicators**
    - **Files:** `apps/web/src/components/features/forms/DynamicFormRenderer.tsx`
  ...
  - [ ] **3.10.7 Atomic: Add tests for form validation and state management**
...
- [ ] **3.11 Story: Real-Time Completion Feedback Component**
  ...
  - [ ] **3.11.1 Atomic: Create CompletionFeedbackPanel component file**
  ...
  - [ ] **3.11.2 Atomic: Calculate completion metrics from formValues**
  ...
  - [ ] **3.11.3 Atomic: Render completion progress bar**
    - **Files:** `apps/web/src/components/features/forms/CompletionFeedbackPanel.tsx`
  ...
  - [ ] **3.11.4 Atomic: Render list of incomplete required fields**
    - **Files:** `apps/web/src/components/features/forms/CompletionFeedbackPanel.tsx`
    - **Dependencies:** Task 3.11.2 must be complete
  ...
  - [ ] **3.11.5 Atomic: Integrate with React Hook Form watch for real-time updates**
  ...
  - [ ] **3.11.6 Atomic: Add visual feedback for 100% completion**
    - **Files:** `apps/web/src/components/features/forms/CompletionFeedbackPanel.tsx`
  ...
  - [ ] **3.11.7 Atomic: Add component tests for CompletionFeedbackPanel**
...
- [ ] **3.12 Story: Client-Side Validation Helper**
  ...
  - [ ] **3.12.1 Atomic: Create formValidation.ts utility file**
  ...
  - [ ] **3.12.2 Atomic: Implement validateTextField for text input**
  ...
  - [ ] **3.12.3 Atomic: Implement validateNumberField for number input**
    - **Files:** `apps/web/src/lib/forms/formValidation.ts`
    - **Dependencies:** Task 3.12.1 must be complete
  ...
  - [ ] **3.12.4 Atomic: Implement validateSelectField for dropdown selection**
    - **Files:** `apps/web/src/lib/forms/formValidation.ts`
    - **Dependencies:** Task 3.12.1 must be complete
  ...
  - [ ] **3.12.5 Atomic: Implement validateCheckboxField for multi-select**
    - **Files:** `apps/web/src/lib/forms/formValidation.ts`
    - **Dependencies:** Task 3.12.1 must be complete
  ...
  - [ ] **3.12.6 Atomic: Implement validateAllFields aggregation function**
    - **Files:** `apps/web/src/lib/forms/formValidation.ts`
  ...
  - [ ] **3.12.7 Atomic: Add unit tests for all validation functions**
...
- [ ] **3.13 Story: Save Responses Integration**
  ...
  - [ ] **3.13.1 Atomic: Integrate useSaveAnswers mutation hook in DynamicFormRenderer**
    - **Files:** `apps/web/src/components/features/forms/DynamicFormRenderer.tsx`
    - **Dependencies:** Stories 3.6, 3.9 must be complete
  ...
  - [ ] **3.13.2 Atomic: Implement manual save button with form submission**
    - **Files:** `apps/web/src/components/features/forms/DynamicFormRenderer.tsx`
  ...
  - [ ] **3.13.3 Atomic: Implement auto-save on field blur with debounce**
    - **Files:** `apps/web/src/components/features/forms/DynamicFormRenderer.tsx`
    - **Dependencies:** Task 3.13.1 must be complete
  ...
  - [ ] **3.13.4 Atomic: Display save status indicator (saving, saved, error)**
    - **Files:** `apps/web/src/components/features/forms/DynamicFormRenderer.tsx`
    - **Dependencies:** Task 3.13.1 must be complete
  ...
  - [ ] **3.13.5 Atomic: Implement optimistic updates for better UX**
    - **Files:** `apps/web/src/components/features/forms/DynamicFormRenderer.tsx`
    - **Dependencies:** Task 3.13.1 must be complete
  ...
  - [ ] **3.13.6 Atomic: Handle save errors with retry mechanism**
    - **Files:** `apps/web/src/components/features/forms/DynamicFormRenderer.tsx`
  ...
  - [ ] **3.13.7 Atomic: Add tests for save integration and optimistic updates**
    - **Files:** `apps/web/src/components/features/forms/DynamicFormRenderer.test.tsx` (UPDATE)
...
- [ ] **3.14 Story: Load Saved Responses Integration**
  ...
  - [ ] **3.14.1 Atomic: Integrate useGetAnswers query hook in DynamicFormRenderer**
    - **Files:** `apps/web/src/components/features/forms/DynamicFormRenderer.tsx`
    - **Dependencies:** Stories 3.6, 3.10 must be complete
  ...
  - [ ] **3.14.2 Atomic: Transform saved responses to form values format**
    - **Files:** `apps/web/src/components/features/forms/DynamicFormRenderer.tsx`
  ...
  - [ ] **3.14.3 Atomic: Pre-populate form fields using setValue or defaultValues**
    - **Files:** `apps/web/src/components/features/forms/DynamicFormRenderer.tsx`
  ...
  - [ ] **3.14.4 Atomic: Display loading skeleton while fetching saved responses**
    - **Files:** `apps/web/src/components/features/forms/DynamicFormRenderer.tsx`
    - **Dependencies:** Task 3.14.1 must be complete
  ...
  - [ ] **3.14.5 Atomic: Handle error state if fetching saved responses fails**
    - **Files:** `apps/web/src/components/features/forms/DynamicFormRenderer.tsx`
    - **Dependencies:** Task 3.14.1 must be complete
  ...
  - [ ] **3.14.6 Atomic: Refetch saved responses after successful save**
    - **Files:** `apps/web/src/components/features/forms/DynamicFormRenderer.tsx`
  ...
  - [ ] **3.14.7 Atomic: Add tests for load saved responses integration**
    - **Files:** `apps/web/src/components/features/forms/DynamicFormRenderer.test.tsx` (UPDATE)
...
- [ ] **3.15 Story: Form Page Implementation**
  ...
  - [ ] **3.15.1 Atomic: Create form page file in App Router**
  ...
  - [ ] **3.15.2 Atomic: Fetch form schema using useGetFormSchema hook**
  ...
  - [ ] **3.15.3 Atomic: Display loading state while fetching form schema**
    - **Files:** `apps/web/src/app/(app)/blgu/assessment/[assessmentId]/indicator/[indicatorId]/page.tsx`
  ...
  - [ ] **3.15.4 Atomic: Display error state if form schema fetch fails**
    - **Files:** `apps/web/src/app/(app)/blgu/assessment/[assessmentId]/indicator/[indicatorId]/page.tsx`
    - **Dependencies:** Task 3.15.2 must be complete
  ...
  - [ ] **3.15.5 Atomic: Render DynamicFormRenderer with form schema**
    - **Files:** `apps/web/src/app/(app)/blgu/assessment/[assessmentId]/indicator/[indicatorId]/page.tsx`
  ...
  - [ ] **3.15.6 Atomic: Render CompletionFeedbackPanel above form**
    - **Files:** `apps/web/src/app/(app)/blgu/assessment/[assessmentId]/indicator/[indicatorId]/page.tsx`
  ...
  - [ ] **3.15.7 Atomic: Add navigation breadcrumbs and back button**
    - **Files:** `apps/web/src/app/(app)/blgu/assessment/[assessmentId]/indicator/[indicatorId]/page.tsx`
  ...
  - [ ] **3.15.8 Atomic: Add page title and metadata**
    - **Files:** `apps/web/src/app/(app)/blgu/assessment/[assessmentId]/indicator/[indicatorId]/page.tsx`
    - **Dependencies:** Task 3.15.2 must be complete
  ...
  - [ ] **3.15.9 Atomic: Add E2E test for form page flow**
...
- [ ] **3.16 Story: Conditional Field Logic Implementation**
  ...
  - [ ] **3.16.1 Atomic: Extract conditional rules from form_schema**
    - **Files:** `apps/web/src/components/features/forms/DynamicFormRenderer.tsx`
    - **Dependencies:** Stories 3.7, 3.10 must be complete
  ...
  - [ ] **3.16.2 Atomic: Watch dependent field values using React Hook Form**
    - **Files:** `apps/web/src/components/features/forms/DynamicFormRenderer.tsx`
  ...
  - [ ] **3.16.3 Atomic: Evaluate conditional visibility for each field**
    - **Files:** `apps/web/src/components/features/forms/DynamicFormRenderer.tsx`
  ...
  - [ ] **3.16.4 Atomic: Conditionally render fields based on visibility state**
    - **Files:** `apps/web/src/components/features/forms/DynamicFormRenderer.tsx`
  ...
  - [ ] **3.16.5 Atomic: Clear hidden field values when fields become invisible**
    - **Files:** `apps/web/src/components/features/forms/DynamicFormRenderer.tsx`
  ...
  - [ ] **3.16.6 Atomic: Re-validate form when conditional fields change**
    - **Files:** `apps/web/src/components/features/forms/DynamicFormRenderer.tsx`
    - **Dependencies:** Task 3.16.3 must be complete
  ...
  - [ ] **3.16.7 Atomic: Add tests for conditional field visibility logic**
    - **Files:** `apps/web/src/components/features/forms/DynamicFormRenderer.test.tsx` (UPDATE)
...
- [ ] **3.17 Story: Form Error Handling and User Feedback**
  ...
  - [ ] **3.17.1 Atomic: Display inline validation errors for each field**
  ...
  - [ ] **3.17.2 Atomic: Display global save error message**
    - **Files:** `apps/web/src/components/features/forms/DynamicFormRenderer.tsx`
  ...
  - [ ] **3.17.3 Atomic: Display network error message with details**
    - **Files:** `apps/web/src/components/features/forms/DynamicFormRenderer.tsx`
  ...
  - [ ] **3.17.4 Atomic: Add retry button for failed save operations**
    - **Files:** `apps/web/src/components/features/forms/DynamicFormRenderer.tsx`
    - **Dependencies:** Task 3.17.2 must be complete
  ...
  - [ ] **3.17.5 Atomic: Display validation error summary at form top**
    - **Files:** `apps/web/src/components/features/forms/DynamicFormRenderer.tsx`
    - **Dependencies:** Story 3.12 must be complete
  ...
  - [ ] **3.17.6 Atomic: Auto-dismiss success message after save**
    - **Files:** `apps/web/src/components/features/forms/DynamicFormRenderer.tsx`
    - **Dependencies:** Story 3.13 must be complete
  ...
  - [ ] **3.17.7 Atomic: Add tests for error handling and user feedback**
    - **Files:** `apps/web/src/components/features/forms/DynamicFormRenderer.test.tsx` (UPDATE)
...
- [ ] **3.18 Story: Testing & Validation** ⚠️ **REQUIRED BEFORE NEXT EPIC**
  ...
  - [ ] **3.18.5 Atomic: Unit test formSchemaParser utilities**
