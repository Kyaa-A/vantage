...
- [ ] **4.4 Story: Backend File Validation Service**
  ...
  - [ ] **4.4.1 Atomic: Create FileValidationService class structure**
  ...
  - [ ] **4.4.2 Atomic: Implement validate_file_type method**
  ...
  - [ ] **4.4.3 Atomic: Implement validate_file_size method**
    - **Files:** `apps/api/app/services/file_validation_service.py`
    - **Dependencies:** Task 4.4.1 must be complete
  ...
  - [ ] **4.4.4 Atomic: Implement validate_file_content method for basic security**
    - **Files:** `apps/api/app/services/file_validation_service.py`
    - **Dependencies:** Task 4.4.1 must be complete
  ...
  - [ ] **4.4.5 Atomic: Implement main validate_file method**
    - **Files:** `apps/api/app/services/file_validation_service.py`
  ...
  - [ ] **4.4.6 Atomic: Create Pydantic ValidationResult schema**
  ...
  - [ ] **4.4.7 Atomic: Test FileValidationService with valid files**
  ...
  - [ ] **4.4.8 Atomic: Test FileValidationService with invalid file types**
  ...
  - [ ] **4.4.9 Atomic: Test FileValidationService with oversized files**
    - **Files:** `apps/api/tests/services/test_file_validation_service.py`
    - **Dependencies:** Tasks 4.4.1-4.4.6 must be complete
  ...
  - [ ] **4.4.10 Atomic: Export FileValidationService singleton instance**
    - **Files:** `apps/api/app/services/file_validation_service.py`
...
- [ ] **4.5 Story: Backend File Upload Service**
  ...
  - [ ] **4.5.1 Atomic: Update StorageService class with file upload dependencies**
  ...
  - [ ] **4.5.2 Atomic: Implement generate_unique_filename helper method**
    - **Files:** `apps/api/app/services/storage_service.py`
  ...
  - [ ] **4.5.3 Atomic: Implement get_storage_path helper method**
    - **Files:** `apps/api/app/services/storage_service.py`
    - **Dependencies:** Task 4.5.1 must be complete
  ...
  - [ ] **4.5.4 Atomic: Implement upload_mov_file method**
    - **Files:** `apps/api/app/services/storage_service.py`
  ...
  - [ ] **4.5.5 Atomic: Implement save_mov_file_record method**
    - **Files:** `apps/api/app/services/storage_service.py`
  ...
  - [ ] **4.5.6 Atomic: Integrate upload_mov_file with save_mov_file_record**
    - **Files:** `apps/api/app/services/storage_service.py`
  ...
  - [ ] **4.5.7 Atomic: Test upload_mov_file with valid file**
  ...
  - [ ] **4.5.8 Atomic: Test upload_mov_file handles Supabase upload failure**
    - **Files:** `apps/api/tests/services/test_storage_service.py`
    - **Dependencies:** Task 4.5.6 must be complete
...
- [ ] **4.6 Story: Backend File Deletion Service**
  ...
  - [ ] **4.6.1 Atomic: Implement delete_file_from_storage helper method**
    - **Files:** `apps/api/app/services/storage_service.py`
  ...
  - [ ] **4.6.2 Atomic: Implement check_delete_permission helper method**
    - **Files:** `apps/api/app/services/storage_service.py`
  ...
  - [ ] **4.6.3 Atomic: Implement delete_mov_file method**
    - **Files:** `apps/api/app/services/storage_service.py`
  ...
  - [ ] **4.6.4 Atomic: Test delete_mov_file with authorized BLGU user**
    - **Files:** `apps/api/tests/services/test_storage_service.py`
  ...
  - [ ] **4.6.5 Atomic: Test delete_mov_file rejects BLGU user for submitted assessment**
    - **Files:** `apps/api/tests/services/test_storage_service.py`
    - **Dependencies:** Task 4.6.3 must be complete
  ...
  - [ ] **4.6.6 Atomic: Test delete_mov_file rejects assessor deletion**
    - **Files:** `apps/api/tests/services/test_storage_service.py`
    - **Dependencies:** Task 4.6.3 must be complete
...
- [ ] **4.7 Story: Backend API for File Upload**
  ...
  - [ ] **4.7.1 Atomic: Create movs.py router file**
  ...
  - [ ] **4.7.2 Atomic: Implement POST upload endpoint structure**
  ...
  - [ ] **4.7.3 Atomic: Integrate FileValidationService in upload endpoint**
    - **Files:** `apps/api/app/api/v1/movs.py`
  ...
  - [ ] **4.7.4 Atomic: Integrate StorageService upload in endpoint**
    - **Files:** `apps/api/app/api/v1/movs.py`
  ...
  - [ ] **4.7.5 Atomic: Create MOVFileResponse Pydantic schema**
  ...
  - [ ] **4.7.6 Atomic: Use MOVFileResponse in upload endpoint return type**
    - **Files:** `apps/api/app/api/v1/movs.py`
  ...
  - [ ] **4.7.7 Atomic: Test upload endpoint with valid file**
  ...
  - [ ] **4.7.8 Atomic: Test upload endpoint rejects invalid file type**
  ...
  - [ ] **4.7.9 Atomic: Test upload endpoint rejects oversized file**
    - **Files:** `apps/api/tests/api/v1/test_movs.py`
    - **Dependencies:** Tasks 4.7.1-4.7.6 must be complete
  ...
  - [ ] **4.7.10 Atomic: Register movs router in main API router**
...
- [ ] **4.8 Story: Backend API for File List Retrieval**
  ...
  - [ ] **4.8.1 Atomic: Implement GET files list endpoint structure**
    - **Files:** `apps/api/app/api/v1/movs.py`
    - **Dependencies:** Task 4.7.1 must be complete
  ...
  - [ ] **4.8.2 Atomic: Implement query logic to fetch MOV files**
    - **Files:** `apps/api/app/api/v1/movs.py`
  ...
  - [ ] **4.8.3 Atomic: Add permission filtering for BLGU users**
    - **Files:** `apps/api/app/api/v1/movs.py`
  ...
  - [ ] **4.8.4 Atomic: Create MOVFileListResponse Pydantic schema**
    - **Files:** `apps/api/app/schemas/assessment.py`
  ...
  - [ ] **4.8.5 Atomic: Use MOVFileListResponse in endpoint return type**
    - **Files:** `apps/api/app/api/v1/movs.py`
  ...
  - [ ] **4.8.6 Atomic: Test files list endpoint for BLGU user**
    - **Files:** `apps/api/tests/api/v1/test_movs.py`
  ...
  - [ ] **4.8.7 Atomic: Test files list endpoint for assessor user**
    - **Files:** `apps/api/tests/api/v1/test_movs.py`
    - **Dependencies:** Tasks 4.8.1-4.8.5 must be complete
  ...
  - [ ] **4.8.8 Atomic: Test files list endpoint excludes soft-deleted files**
    - **Files:** `apps/api/tests/api/v1/test_movs.py`
    - **Dependencies:** Tasks 4.8.1-4.8.5 must be complete
...
- [ ] **4.9 Story: Backend API for File Deletion**
  ...
  - [ ] **4.9.1 Atomic: Implement DELETE file endpoint structure**
    - **Files:** `apps/api/app/api/v1/movs.py`
    - **Dependencies:** Task 4.7.1 must be complete
  ...
  - [ ] **4.9.2 Atomic: Integrate StorageService delete in endpoint**
    - **Files:** `apps/api/app/api/v1/movs.py`
  ...
  - [ ] **4.9.3 Atomic: Test delete endpoint with authorized BLGU user**
    - **Files:** `apps/api/tests/api/v1/test_movs.py`
  ...
  - [ ] **4.9.4 Atomic: Test delete endpoint rejects BLGU user for submitted assessment**
    - **Files:** `apps/api/tests/api/v1/test_movs.py`
    - **Dependencies:** Tasks 4.9.1-4.9.2 must be complete
  ...
  - [ ] **4.9.5 Atomic: Test delete endpoint rejects assessor deletion**
    - **Files:** `apps/api/tests/api/v1/test_movs.py`
    - **Dependencies:** Tasks 4.9.1-4.9.2 must be complete
  ...
  - [ ] **4.9.6 Atomic: Test delete endpoint returns 404 for non-existent file**
    - **Files:** `apps/api/tests/api/v1/test_movs.py`
    - **Dependencies:** Tasks 4.9.1-4.9.2 must be complete
...
- [ ] **4.10 Story: Pydantic Schemas for File Operations**
  ...
  - [ ] **4.10.1 Atomic: Verify MOVFileResponse schema completeness**
    - **Files:** `apps/api/app/schemas/assessment.py`
  ...
  - [ ] **4.10.2 Atomic: Add UploaderInfo nested schema to MOVFileResponse**
    - **Files:** `apps/api/app/schemas/assessment.py`
  ...
  - [ ] **4.10.3 Atomic: Verify MOVFileListResponse schema**
    - **Files:** `apps/api/app/schemas/assessment.py`
  ...
  - [ ] **4.10.4 Atomic: Ensure all MOV schemas have proper Orval tags**
    - **Files:** `apps/api/app/api/v1/movs.py`
...
- [ ] **4.11 Story: Type Generation for File APIs**
  ...
  - [ ] **4.11.1 Atomic: Run pnpm generate-types after MOV endpoints complete**
  ...
  - [ ] **4.11.2 Atomic: Verify MOVFileResponse TypeScript type generated**
  ...
  - [ ] **4.11.3 Atomic: Verify useUploadMOVFile hook generated**
  ...
  - [ ] **4.11.4 Atomic: Verify useGetMOVFiles hook generated**
    - **Files:** `packages/shared/src/generated/endpoints/movs/movs.ts`
    - **Dependencies:** Task 4.11.1 must be complete
  ...
  - [ ] **4.11.5 Atomic: Verify useDeleteMOVFile hook generated**
    - **Files:** `packages/shared/src/generated/endpoints/movs/movs.ts`
    - **Dependencies:** Task 4.11.1 must be complete
  ...
  - [ ] **4.11.6 Atomic: Test generated hooks in TypeScript environment**
...
- [ ] **4.12 Story: File Upload Component with Drag-and-Drop**
  ...
  - [ ] **4.12.1 Atomic: Create MOVFileUpload component file structure**
  ...
  - [ ] **4.12.2 Atomic: Install and configure react-dropzone**
  ...
  - [ ] **4.12.3 Atomic: Implement dropzone UI with drag-and-drop area**
  ...
  - [ ] **4.12.4 Atomic: Integrate useUploadMOVFile mutation hook**
    - **Files:** `apps/web/src/components/features/assessments/mov/MOVFileUpload.tsx`
  ...
  - [ ] **4.12.5 Atomic: Implement file upload on drop**
    - **Files:** `apps/web/src/components/features/assessments/mov/MOVFileUpload.tsx`
  ...
  - [ ] **4.12.6 Atomic: Display file upload progress for each file**
    - **Files:** `apps/web/src/components/features/assessments/mov/MOVFileUpload.tsx`
  ...
  - [ ] **4.12.7 Atomic: Display validation errors for rejected files**
    - **Files:** `apps/web/src/components/features/assessments/mov/MOVFileUpload.tsx`
    - **Dependencies:** Task 4.12.2 must be complete
  ...
  - [ ] **4.12.8 Atomic: Add retry functionality for failed uploads**
    - **Files:** `apps/web/src/components/features/assessments/mov/MOVFileUpload.tsx`
  ...
  - [ ] **4.12.9 Atomic: Call onUploadSuccess callback after successful upload**
    - **Files:** `apps/web/src/components/features/assessments/mov/MOVFileUpload.tsx`
    - **Dependencies:** Task 4.12.5 must be complete
  ...
  - [ ] **4.12.10 Atomic: Add accessibility attributes to dropzone**
    - **Files:** `apps/web/src/components/features/assessments/mov/MOVFileUpload.tsx`
...
- [ ] **4.13 Story: File List Display Component**
  ...
  - [ ] **4.13.1 Atomic: Create MOVFileList component file structure**
  ...
  - [ ] **4.13.2 Atomic: Integrate useGetMOVFiles query hook**
  ...
  - [ ] **4.13.3 Atomic: Render file list using shadcn/ui Table**
    - **Files:** `apps/web/src/components/features/assessments/mov/MOVFileList.tsx`
  ...
  - [ ] **4.13.4 Atomic: Add file type icons to file list**
    - **Files:** `apps/web/src/components/features/assessments/mov/MOVFileList.tsx`
  ...
  - [ ] **4.13.5 Atomic: Format file size for display**
  ...
  - [ ] **4.13.6 Atomic: Format upload date for display**
    - **Files:** `apps/web/src/components/features/assessments/mov/MOVFileList.tsx`
    - **Dependencies:** Task 4.13.3 must be complete
  ...
  - [ ] **4.13.7 Atomic: Add download link for each file**
    - **Files:** `apps/web/src/components/features/assessments/mov/MOVFileList.tsx`
    - **Dependencies:** Task 4.13.3 must be complete
  ...
  - [ ] **4.13.8 Atomic: Display uploader information**
    - **Files:** `apps/web/src/components/features/assessments/mov/MOVFileList.tsx`
    - **Dependencies:** Task 4.13.3 must be complete
  ...
  - [ ] **4.13.9 Atomic: Add loading skeleton for file list**
    - **Files:** `apps/web/src/components/features/assessments/mov/MOVFileList.tsx`
    - **Dependencies:** Task 4.13.2 must be complete
  ...
  - [ ] **4.13.10 Atomic: Add error state for file list**
    - **Files:** `apps/web/src/components/features/assessments/mov/MOVFileList.tsx`
    - **Dependencies:** Task 4.13.2 must be complete
...
- [ ] **4.14 Story: File Delete Functionality**
  ...
  - [ ] **4.14.1 Atomic: Add delete button to file list actions column**
    - **Files:** `apps/web/src/components/features/assessments/mov/MOVFileList.tsx`
    - **Dependencies:** Task 4.13.3 must be complete
  ...
  - [ ] **4.14.2 Atomic: Integrate useDeleteMOVFile mutation hook**
    - **Files:** `apps/web/src/components/features/assessments/mov/MOVFileList.tsx`
  ...
  - [ ] **4.14.3 Atomic: Create confirmation dialog component**
    - **Files:** `apps/web/src/components/features/assessments/mov/MOVFileList.tsx`
  ...
  - [ ] **4.14.4 Atomic: Wire delete button to confirmation dialog**
    - **Files:** `apps/web/src/components/features/assessments/mov/MOVFileList.tsx`
  ...
  - [ ] **4.14.5 Atomic: Disable delete button based on assessment status**
    - **Files:** `apps/web/src/components/features/assessments/mov/MOVFileList.tsx`
    - **Dependencies:** Task 4.14.1 must be complete
  ...
  - [ ] **4.14.6 Atomic: Disable delete button for non-owner files**
    - **Files:** `apps/web/src/components/features/assessments/mov/MOVFileList.tsx`
    - **Dependencies:** Task 4.14.1 must be complete
  ...
  - [ ] **4.14.7 Atomic: Show loading state during deletion**
    - **Files:** `apps/web/src/components/features/assessments/mov/MOVFileList.tsx`
  ...
  - [ ] **4.14.8 Atomic: Handle delete success with optimistic update**
    - **Files:** `apps/web/src/components/features/assessments/mov/MOVFileList.tsx`
    - **Dependencies:** Task 4.14.2 must be complete
  ...
  - [ ] **4.14.9 Atomic: Handle delete error**
    - **Files:** `apps/web/src/components/features/assessments/mov/MOVFileList.tsx`
    - **Dependencies:** Task 4.14.2 must be complete
...
- [ ] **4.15 Story: File Upload Integration with Dynamic Form**
  ...
  - [ ] **4.15.1 Atomic: Locate FileFieldComponent from Epic 3**
  ...
  - [ ] **4.15.2 Atomic: Import MOVFileUpload and MOVFileList components**
  ...
  - [ ] **4.15.3 Atomic: Replace basic file input with MOVFileUpload component**
    - **Files:** `apps/web/src/components/features/assessments/form/FileFieldComponent.tsx`
  ...
  - [ ] **4.15.4 Atomic: Add MOVFileList component below file upload**
    - **Files:** `apps/web/src/components/features/assessments/form/FileFieldComponent.tsx`
    - **Dependencies:** Task 4.15.2 must be complete
  ...
  - [ ] **4.15.5 Atomic: Add section divider and labels**
    - **Files:** `apps/web/src/components/features/assessments/form/FileFieldComponent.tsx`
  ...
  - [ ] **4.15.6 Atomic: Pass assessmentStatus from form context to FileFieldComponent**
  ...
  - [ ] **4.15.7 Atomic: Pass currentUserId from auth context to FileFieldComponent**
  ...
  - [ ] **4.15.8 Atomic: Test FileFieldComponent integration in form page**
...
- [ ] **4.16 Story: File Upload Progress and Status Feedback**
  ...
  - [ ] **4.16.1 Atomic: Verify upload progress already implemented in MOVFileUpload**
    - **Files:** `apps/web/src/components/features/assessments/mov/MOVFileUpload.tsx`
    - **Dependencies:** Task 4.12.6 must be complete
  ...
  - [ ] **4.16.2 Atomic: Add upload status icons (success, error)**
    - **Files:** `apps/web/src/components/features/assessments/mov/MOVFileUpload.tsx`
    - **Dependencies:** Task 4.12.6 must be complete
  ...
  - [ ] **4.16.3 Atomic: Display specific error messages for upload failures**
    - **Files:** `apps/web/src/components/features/assessments/mov/MOVFileUpload.tsx`
    - **Dependencies:** Task 4.12.5 must be complete
  ...
  - [ ] **4.16.4 Atomic: Verify retry functionality already implemented**
    - **Files:** `apps/web/src/components/features/assessments/mov/MOVFileUpload.tsx`
  ...
  - [ ] **4.16.5 Atomic: Add clear/dismiss button for completed uploads**
    - **Files:** `apps/web/src/components/features/assessments/mov/MOVFileUpload.tsx`
    - **Dependencies:** Task 4.12.6 must be complete
  ...
  - [ ] **4.16.6 Atomic: Auto-clear successful uploads after 5 seconds**
    - **Files:** `apps/web/src/components/features/assessments/mov/MOVFileUpload.tsx`
    - **Dependencies:** Task 4.12.6 must be complete
...
- [ ] **4.17 Story: Permission-Based UI Controls**
  ...
  - [ ] **4.17.1 Atomic: Add assessmentStatus prop to MOVFileUpload component**
    - **Files:** `apps/web/src/components/features/assessments/mov/MOVFileUpload.tsx`
    - **Dependencies:** Task 4.12.1 must be complete
  ...
  - [ ] **4.17.2 Atomic: Disable dropzone when assessment is submitted**
    - **Files:** `apps/web/src/components/features/assessments/mov/MOVFileUpload.tsx`
  ...
  - [ ] **4.17.3 Atomic: Show info banner when uploads disabled**
    - **Files:** `apps/web/src/components/features/assessments/mov/MOVFileUpload.tsx`
  ...
  - [ ] **4.17.4 Atomic: Verify delete button permissions already implemented in MOVFileList**
    - **Files:** `apps/web/src/components/features/assessments/mov/MOVFileList.tsx`
  ...
  - [ ] **4.17.5 Atomic: Add read-only mode indicator to MOVFileList**
    - **Files:** `apps/web/src/components/features/assessments/mov/MOVFileList.tsx`
  ...
  - [ ] **4.17.6 Atomic: Pass assessmentStatus from parent to both upload and list components**
    - **Files:** `apps/web/src/components/features/assessments/form/FileFieldComponent.tsx`
  ...
  - [ ] **4.17.7 Atomic: Test permission controls with different assessment statuses**
    - **Files:** Manual testing in browser
...
- [ ] **4.18 Story: File Preview Functionality**
  ...
  - [ ] **4.18.1 Atomic: Add preview button to file list for previewable files**
    - **Files:** `apps/web/src/components/features/assessments/mov/MOVFileList.tsx`
    - **Dependencies:** Task 4.13.3 must be complete
  ...
  - [ ] **4.18.2 Atomic: Create FilePreviewModal component**
  ...
  - [ ] **4.18.3 Atomic: Implement image preview in modal**
  ...
  - [ ] **4.18.4 Atomic: Install and configure react-pdf library**
  ...
  - [ ] **4.18.5 Atomic: Implement PDF preview in modal**
    - **Files:** `apps/web/src/components/features/assessments/mov/FilePreviewModal.tsx`
  ...
  - [ ] **4.18.6 Atomic: Add download button to preview modal**
    - **Files:** `apps/web/src/components/features/assessments/mov/FilePreviewModal.tsx`
    - **Dependencies:** Task 4.18.2 must be complete
  ...
  - [ ] **4.18.7 Atomic: Wire preview button to open modal**
    - **Files:** `apps/web/src/components/features/assessments/mov/MOVFileList.tsx`
  ...
  - [ ] **4.18.8 Atomic: Add loading state for PDF preview**
    - **Files:** `apps/web/src/components/features/assessments/mov/FilePreviewModal.tsx`
  ...
  - [ ] **4.18.9 Atomic: Add keyboard shortcuts to preview modal**
    - **Files:** `apps/web/src/components/features/assessments/mov/FilePreviewModal.tsx`
    - **Dependencies:** Task 4.18.2 must be complete
  ...
  - [ ] **4.18.10 Atomic: Test file preview functionality**
    - **Files:** Manual testing in browser
...
- [ ] **4.19 Story: Testing & Validation** ⚠️ **REQUIRED BEFORE NEXT EPIC**
  ...
  - [ ] **4.19.1 Atomic: Review and verify FileValidationService tests already exist**
    - **Files:** `apps/api/tests/services/test_file_validation_service.py`
  ...
  - [ ] **4.19.2 Atomic: Review and verify StorageService tests already exist**
    - **Files:** `apps/api/tests/services/test_storage_service.py`
  ...
  - [ ] **4.19.3 Atomic: Review and verify MOV API endpoint tests already exist**
    - **Files:** `apps/api/tests/api/v1/test_movs.py`
  ...
  - [ ] **4.19.4 Atomic: Add integration test for complete upload-list-delete flow**
  ...
  - [ ] **4.19.5 Atomic: Add test for concurrent file uploads**
    - **Files:** `apps/api/tests/api/v1/test_movs.py`
  ...
  - [ ] **4.19.6 Atomic: Create MOVFileUpload component test file**
  ...
  - [ ] **4.19.7 Atomic: Test MOVFileUpload renders dropzone**
  ...
  - [ ] **4.19.8 Atomic: Test MOVFileUpload handles file drop**
    - **Files:** `apps/web/src/components/features/assessments/mov/MOVFileUpload.test.tsx`
    - **Dependencies:** Task 4.19.6 must be complete
  ...
  - [ ] **4.19.9 Atomic: Test MOVFileUpload shows validation errors**
    - **Files:** `apps/web/src/components/features/assessments/mov/MOVFileUpload.test.tsx`
    - **Dependencies:** Task 4.19.6 must be complete
  ...
  - [ ] **4.19.10 Atomic: Test MOVFileUpload disables when assessment submitted**
    - **Files:** `apps/web/src/components/features/assessments/mov/MOVFileUpload.test.tsx`
  ...
  - [ ] **4.19.11 Atomic: Create MOVFileList component test file**
  ...
  - [ ] **4.19.12 Atomic: Test MOVFileList renders file list**
  ...
  - [ ] **4.19.13 Atomic: Test MOVFileList delete button triggers confirmation**
    - **Files:** `apps/web/src/components/features/assessments/mov/MOVFileList.test.tsx`
  ...
  - [ ] **4.19.14 Atomic: Test MOVFileList delete confirmation calls mutation**
    - **Files:** `apps/web/src/components/features/assessments/mov/MOVFileList.test.tsx`
    - **Dependencies:** Task 4.19.11, Story 4.14 must be complete
  ...
  - [ ] **4.19.15 Atomic: Test MOVFileList shows loading state**
    - **Files:** `apps/web/src/components/features/assessments/mov/MOVFileList.test.tsx`
    - **Dependencies:** Task 4.19.11 must be complete
  ...
  - [ ] **4.19.16 Atomic: Test MOVFileList shows error state**
    - **Files:** `apps/web/src/components/features/assessments/mov/MOVFileList.test.tsx`
    - **Dependencies:** Task 4.19.11 must be complete
  ...
  - [ ] **4.19.17 Atomic: Create E2E test for MOV upload workflow**
  ...
  - [ ] **4.19.18 Atomic: E2E test: BLGU uploads file**
  ...
  - [ ] **4.19.19 Atomic: E2E test: BLGU previews file**
    - **Files:** `apps/web/tests/e2e/mov-upload.spec.ts`
  ...
  - [ ] **4.19.20 Atomic: E2E test: BLGU deletes file**
    - **Files:** `apps/web/tests/e2e/mov-upload.spec.ts`
  ...
  - [ ] **4.19.21 Atomic: E2E test: BLGU cannot delete file from submitted assessment**
    - **Files:** `apps/web/tests/e2e/mov-upload.spec.ts`
  ...
  - [ ] **4.19.22 Atomic: E2E test: Upload invalid file type**
    - **Files:** `apps/web/tests/e2e/mov-upload.spec.ts`
    - **Dependencies:** Task 4.19.17 must be complete
  ...
  - [ ] **4.19.23 Atomic: Performance test: Upload large file (near 50MB limit)**
  ...
  - [ ] **4.19.24 Atomic: Security test: Reject malicious file upload**
  ...
  - [ ] **4.19.25 Atomic: Verify all Epic 4 tests pass in CI**
